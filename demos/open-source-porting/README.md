...
resource declarations. Metal is excluded because program-scope constant-buffer
lowering currently inserts a placeholder initializer, tracked in issue #837.
OpenGL is excluded because legacy HLSL sampler-register metadata is not yet
lowered to an OpenGL binding, tracked in issue #838.
