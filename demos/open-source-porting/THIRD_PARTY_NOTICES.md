...
The demo source files are copied or reduced from the upstream projects listed
...
- Commit: `ab1e93d4a5dadf4c804fb6abbbe0b27dfa912b5a`
- Source path: `shaders/dynamic_line_rasterization/glsl/grid.frag`
- License: Apache-2.0
- License URL:
...
- Source path:
  `MetalSampleCodeLibrary/MultipleTechniques/ModernRenderingWithMetal/Renderer/Shaders/AAPLMeshRenderer.metal`
- License: MIT
- License URL:
...
- Commit: `b467b4b1dee0f7d9d43bda13856306ca3f1baea5`
- Source paths:
  - `metal_performance_testing/mat_mul_simple1.metal`
  - `metal_performance_testing/ShaderParams.h`
- License: BSD-style permissive license
- License URL:
...
- Source path: `samples/core/saxpy/saxpy.cl`
- License: Apache-2.0
- License URL:
...
- Source path: `shaders/frag/round.frag`
- License: Apache-2.0
- License URL:
