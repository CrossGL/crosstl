...
TOKENS = tuple(
    [
        ...
        ("__RESTRICT__", r"\b__restrict(?:__)?\b"),
        ...
        ("ATOMICADD", r"\batomicAdd(?:_system)?\b|hipAtomicAdd\b"),
        ("ATOMICSUB", r"\batomicSub(?:_system)?\b|hipAtomicSub\b"),
        ("ATOMICMAX", r"\batomicMax(?:_system)?\b|hipAtomicMax\b"),
        ("ATOMICMIN", r"\batomicMin(?:_system)?\b|hipAtomicMin\b"),
        ("ATOMICEXCH", r"\batomicExch(?:_system)?\b|hipAtomicExch\b"),
        ("ATOMICCAS", r"\batomicCAS(?:_system)?\b|hipAtomicCAS\b"),
