...
KEYWORDS = {
    ...
    "blockDim": "BLOCKDIM",
    "warpSize": "WARPSIZE",
    "hipThreadIdx_x": "HIPTHREADIDX",
    "hipThreadIdx_y": "HIPTHREADIDX",
    "hipThreadIdx_z": "HIPTHREADIDX",
    "hipBlockIdx_x": "HIPBLOCKIDX",
    "hipBlockIdx_y": "HIPBLOCKIDX",
    "hipBlockIdx_z": "HIPBLOCKIDX",
    "hipBlockDim_x": "HIPBLOCKDIM",
    "hipBlockDim_y": "HIPBLOCKDIM",
    "hipBlockDim_z": "HIPBLOCKDIM",
    "hipGridDim_x": "HIPGRIDDIM",
    "hipGridDim_y": "HIPGRIDDIM",
    "hipGridDim_z": "HIPGRIDDIM",
    "__syncthreads": "SYNCTHREADS",
    "hipDeviceSynchronize": "SYNCTHREADS",
    "__syncwarp": "SYNCWARP",
    "atomicAdd": "ATOMICADD",
    ...
    "hipAtomicExch": "ATOMICEXCH",
    "atomicCAS": "ATOMICCAS",
    "hipAtomicCAS": "ATOMICCAS",
    "hipError_t": "HIPERROR",
...
class HipLexer:
    ...
    @classmethod
    def from_file(cls, filepath: str) -> "HipLexer":
...
class Lexer:
    """Compatibility wrapper around HipLexer"""

    def __init__(self, input_str):
        self.lexer = HipLexer(input_str)
