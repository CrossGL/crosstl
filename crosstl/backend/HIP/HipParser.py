...
from .HipAst import (
    ...
    HipEnumValueNode,
    HipExpressionNode,
    HipExpressionStatementNode,
    HipExternBlockNode,
    HipFunctionCallNode,
    HipFunctionNode,
    HipIdentifierNode,
    HipInheritanceNode,
    HipInitializerListNode,
    HipLiteralNode,
    HipMemberAccessNode,
    HipMemberFunctionNode,
    HipMemberInitializerNode,
    HipMemberVariableNode,
    HipNamespaceNode,
    HipOperatorOverloadNode,
    HipParameterNode,
    HipPointerMemberAccessNode,
    HipPostfixOpNode,
    HipPreprocessorNode,
    HipProgramNode,
    HipStructMemberNode,
    HipStructNode,
    HipTemplateNode,
    HipTemplateParameterNode,
    HipTypeNode,
    HipTypedefNode,
    HipUnaryOpNode,
    HipUsingNode,
    HipVariableDeclarationNode,
    HipVariableNode,
)
...
class HipParser:
    ...
    def parse_unary_expression(self) -> HipExpressionNode:
        ...
        if self.match(
            "PLUS", "MINUS", "NOT", "STAR", "AMPERSAND", "INCREMENT", "DECREMENT"
        ):
            op = self.current_token.value
            self.advance()
            expr = self.parse_unary_expression()
    ...
    def is_function_declaration(self) -> bool:
        ...
        try:
            # Skip qualifiers
            while self.match(
                "INLINE", "STATIC", "EXTERN", "VIRTUAL", "CONST", "CONSTEXPR"
            ):
                self.advance()
