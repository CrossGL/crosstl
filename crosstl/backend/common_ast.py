...
class IfNode(ASTNode):
    ...
    def __init__(self, condition=None, if_body=None, else_body=None, if_chain=None, else_if_chain=None):
        ...
        if if_chain is not None or else_if_chain is not None:
            ...
            if self.if_chain:
                self.condition = condition or (self.if_chain[0][0] if self.if_chain else None)
                self.if_body = if_body or (self.if_chain[0][1] if self.if_chain else None)
            else:
