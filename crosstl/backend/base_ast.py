...
class BaseBinaryOpNode(ASTNode):
    ...
    def __init__(
        self, left: "ExpressionNode", op: str, right: "ExpressionNode", **kwargs
    ):
...
class BaseUnaryOpNode(ASTNode):
    ...
    def __init__(
        self, op: str, operand: "ExpressionNode", is_postfix: bool = False, **kwargs
    ):
...
class BaseFunctionCallNode(ASTNode):
    ...
    def __init__(
        self, name: Union[str, "ExpressionNode"], args: List["ExpressionNode"], **kwargs
    ):
...
class BaseArrayAccessNode(ASTNode):
    ...
    def __init__(self, array: "ExpressionNode", index: "ExpressionNode", **kwargs):
...
class BaseIfNode(ASTNode):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.else_body = (
            else_body
            if else_body is None or isinstance(else_body, list)
            else [else_body]
        )
...
class BasePreprocessorNode(ASTNode):
    ...
    def __repr__(self) -> str:
        return (
            f"BasePreprocessorNode(directive={self.directive}, content={self.content})"
        )
...
class BaseAttributeNode(ASTNode):
    ...
    def __init__(self, name: str, args: Optional[List[str]] = None, **kwargs):
...
class BaseVectorConstructorNode(ASTNode):
    ...
    def __init__(self, vector_type: str, args: List["ExpressionNode"], **kwargs):
...
class BaseKernelNode(BaseFunctionNode):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            return_type, name, params, body, ["__global__"], attributes, **kwargs
        )
...
class BaseAtomicOperationNode(BaseFunctionCallNode):
    ...
    def __init__(self, operation: str, args: List["ExpressionNode"], **kwargs):
...
class BaseSyncNode(ASTNode):
    ...
    def __init__(
        self, sync_type: str, args: Optional[List["ExpressionNode"]] = None, **kwargs
    ):
