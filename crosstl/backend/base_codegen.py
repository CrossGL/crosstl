...
class TypeMapping:
    ...
    BACKEND_MAPPINGS = {
        ...
        "rust": {
            "void": "()",
            "int": "i32", "uint": "u32", "float": "f32", "double": "f64",
            ...
            "mat2": "Mat2<f32>", "mat3": "Mat3<f32>", "mat4": "Mat4<f32>",
        },
        "mojo": {
            "void": "None",
            "int": "Int32", "uint": "UInt32", "float": "Float32", "double": "Float64",
            "vec2": "SIMD[DType.float32, 2]", "vec3": "SIMD[DType.float32, 3]", "vec4": "SIMD[DType.float32, 4]",
            "ivec2": "SIMD[DType.int32, 2]", "ivec3": "SIMD[DType.int32, 3]", "ivec4": "SIMD[DType.int32, 4]",
            "mat2": "Matrix[DType.float32, 2, 2]", "mat3": "Matrix[DType.float32, 3, 3]", "mat4": "Matrix[DType.float32, 4, 4]",
        },
        "hip": {
            "vec2": "float2", "vec3": "float3", "vec4": "float4",
            "ivec2": "int2", "ivec3": "int3", "ivec4": "int4",
...
class CodeGenFactory:
    ...
    @classmethod
    def create_crossgl_converter(cls, source_language: str) -> CrossGLToCrossGLConverter:
...
def format_function_signature(return_type: str, name: str, params: List[str], 
                            qualifiers: Optional[List[str]] = None) -> str:
