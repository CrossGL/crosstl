...
class Token:
    ...
    def __init__(
        self, token_type: TokenType, value: str, line: int = 1, column: int = 1
    ):
    ...
    def tokenize(self) -> List[Token]:
        ...
        while pos < self.length:
            ...
            if token_result is None:
                raise SyntaxError(
                    f"Illegal character '{self.code[pos]}' at line {self.line}, column {self.column}"
                )
...
class LanguageSpecificMixin:
    ...
    def add_language_patterns(
        self,
        base_patterns: List[Tuple[TokenType, str]],
        language_patterns: List[Tuple[TokenType, str]],
    ...
    def merge_keywords(
        self,
        base_keywords: Dict[str, TokenType],
        language_keywords: Dict[str, TokenType],
    ) -> Dict[str, TokenType]:
...
def convert_string_tokens_to_objects(
    string_tokens: List[Tuple[str, str]],
) -> List[Token]:
