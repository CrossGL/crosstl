...
class ArrayType(TypeNode):
    ...
    def __init__(self, element_type: TypeNode, size: Optional[Union[int, ASTNode]] = None, **kwargs):
        super().__init__(**kwargs)
        self.element_type = element_type
...
class StageNode(ASTNode):
    ...
    def __init__(self,
        ...
        self.execution_config = execution_config or {}  # For compute workgroup size, etc.
...
class ImportNode(ASTNode):
    ...
    def __init__(self, path: str, alias: Optional[str] = None, items: List[str] = None, **kwargs):
        super().__init__(**kwargs)
        self.path = path
        self.alias = alias
...
class TextureNode(ExpressionNode):
    ...
    def __repr__(self):
        return f"TextureNode(texture={self.texture_expr}, coordinates={self.coordinates})"
...
class TextureResourceNode(ASTNode):
    ...
    def __repr__(self):
        return f"TextureResourceNode(name={self.name}, texture_type={self.texture_type})"
