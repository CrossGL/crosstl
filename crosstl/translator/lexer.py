...
KEYWORDS = {
    # Core Language
    "shader": "SHADER", "struct": "STRUCT", "enum": "ENUM", "impl": "IMPL",
    "trait": "TRAIT", "class": "CLASS", "interface": "INTERFACE", 
    "namespace": "NAMESPACE", "module": "MODULE", "import": "IMPORT",
    "use": "USE", "from": "FROM", "as": "AS",
    
    # Functions
    "fn": "FUNCTION", "void": "VOID", "return": "RETURN", "yield": "YIELD",
    "async": "ASYNC", "await": "AWAIT",
    
    # Control Flow
    "if": "IF", "else": "ELSE", "elif": "ELIF", "match": "MATCH",
    "switch": "SWITCH", "case": "CASE", "default": "DEFAULT",
    "for": "FOR", "while": "WHILE", "loop": "LOOP", "in": "IN",
    "break": "BREAK", "continue": "CONTINUE",
    
    # Variables
    "let": "LET", "var": "VAR", "mut": "MUT", "const": "CONST",
    "static": "STATIC", "extern": "EXTERN", "uniform": "UNIFORM",
    "cbuffer": "CBUFFER",
    
    # Visibility
    "pub": "PUBLIC", "priv": "PRIVATE", "protected": "PROTECTED",
    "internal": "INTERNAL",
    
    # Safety
    "unsafe": "UNSAFE", "safe": "SAFE", "ref": "REF",
    "box": "BOX", "move": "MOVE",
    
    # Shader Stages
    "vertex": "VERTEX", "fragment": "FRAGMENT", "compute": "COMPUTE",
    "geometry": "GEOMETRY", "tessellation": "TESSELLATION",
    
    # GPU
    "kernel": "KERNEL", "global": "GLOBAL", "local": "LOCAL",
    "shared": "SHARED", "threadgroup": "THREADGROUP", "workgroup": "WORKGROUP",
    ...
    "half": "HALF", "char": "CHAR", "string": "STRING",
    ...
    # Textures/Samplers
    "texture1d": "TEXTURE1D", "texture2d": "TEXTURE2D", "texture3d": "TEXTURE3D",
    "texturecube": "TEXTURECUBE", "texture2darray": "TEXTURE2DARRAY",
    "sampler": "SAMPLER", "sampler1d": "SAMPLER1D", "sampler2d": "SAMPLER2D",
