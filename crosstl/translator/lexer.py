...
TOKENS = OrderedDict(
    [
        ...
        ("ISAMPLER1D", r"\bisampler1[Dd]\b"),
        ("ISAMPLER1DARRAY", r"\bisampler1[Dd][Aa]rray\b"),
        ("ISAMPLER2D", r"\bisampler2[Dd]\b"),
        ("ISAMPLER3D", r"\bisampler3[Dd]\b"),
        ("ISAMPLERCUBE", r"\bisampler[Cc]ube\b"),
        ("ISAMPLERCUBEARRAY", r"\bisampler[Cc]ube[Aa]rray\b"),
        ("ISAMPLER2DARRAY", r"\bisampler2[Dd][Aa]rray\b"),
        ("ISAMPLER2DMS", r"\bisampler2[Dd][Mm][Ss]\b"),
        ("ISAMPLER2DMSARRAY", r"\bisampler2[Dd][Mm][Ss][Aa]rray\b"),
        ("USAMPLER1D", r"\busampler1[Dd]\b"),
        ("USAMPLER1DARRAY", r"\busampler1[Dd][Aa]rray\b"),
        ("USAMPLER2D", r"\busampler2[Dd]\b"),
        ("USAMPLER3D", r"\busampler3[Dd]\b"),
        ("USAMPLERCUBE", r"\busampler[Cc]ube\b"),
        ("USAMPLERCUBEARRAY", r"\busampler[Cc]ube[Aa]rray\b"),
        ("USAMPLER2DARRAY", r"\busampler2[Dd][Aa]rray\b"),
        ("USAMPLER2DMS", r"\busampler2[Dd][Mm][Ss]\b"),
        ("USAMPLER2DMSARRAY", r"\busampler2[Dd][Mm][Ss][Aa]rray\b"),
