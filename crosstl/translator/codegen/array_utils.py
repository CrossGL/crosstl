...
def format_array_type(base_type: str, size: Optional[int], 
                     lang_style: str = 'glsl') -> str:
...
def detect_array_element_type(array_type: str, 
                             type_mapping: Dict[str, Any] = None) -> str:
