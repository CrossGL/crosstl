...
model = AutoModelForCausalLM.from_pretrained(model_name) # Creating an Instance of the Model.
...
def chat_with_bot(user_input, chat_history_ids=None):
    ...
    chat_history_ids = model.generate(bot_input_ids, max_length=1000, pad_token_id=tokenizer.eos_token_id) # Limiting the Output Text to atmost 1000 words.
