...
class UniversalTypeMapper:
    ...
    def map_type(
        cls,
        type_name: Union[str, BaseType, VectorType, MatrixType, TextureType],
        backend: str,
    ) -> str:
    ...
    def _find_type_enum(
        cls, type_name: str
    ) -> Union[BaseType, VectorType, MatrixType, TextureType, str]:
    ...
    @classmethod
    def add_backend_mapping(
        cls,
        backend: str,
        mappings: Dict[Union[BaseType, VectorType, MatrixType, TextureType], str],
    ):
        ...
        if type_string in [mt.value for mt in MatrixType]:
            ...
            if "mat" in type_string:
                ...
                base = (
                    ...
                    else BaseType.FLOAT32
                )
                return TypeDescriptor(
                    base_type=base, matrix_rows=rows, matrix_cols=cols
                )
