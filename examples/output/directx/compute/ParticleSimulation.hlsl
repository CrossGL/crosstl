...
VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3)
    random3(VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3) seed)
{
...
VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3)
    calculateAttraction(VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3) position,
                        VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3)
                            attractor_pos,
                        float strength)
{
...
bool checkCollision(VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3) pos1,
                    VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3) pos2,
                    float radius)
{
...
VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3)
    resolveCollision(VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3) pos1,
                     VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3) vel1,
                     VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3) pos2,
                     VectorType(element_type = PrimitiveType(name = float, size_bits = None), size = 3) vel2,
...
void spawn()
{
    ...
    for (i; (i < physics.max_particles); ++i)
    {
