...
.. csv-table:: Backend inventory
   ...
   "Rust", ".rs", "crosstl/translator/codegen/rust_codegen.py", "crosstl/backend/Rust", "tests/test_translator/test_codegen/test_rust_codegen.py, tests/test_backend/test_rust", "628", "46", "Rust reference"
   "Slang", ".slang", "crosstl/translator/codegen/slang_codegen.py", "crosstl/backend/slang", "tests/test_translator/test_codegen/test_slang_codegen.py, tests/test_backend/test_slang", "465", "321", "Slang user guide"
...
.. csv-table:: DirectX/OpenGL/Metal backlog
   ...
   "OpenGL / GLSL", "language", "Wave/subgroup intrinsics", "partial", "Lowers CrossGL Wave* lane, vote, reduction, ballot, shuffle, and quad operations to GL_KHR_shader_subgroup builtins with required extension declarations. WaveMatch and WaveMultiPrefix* partition-mask forms emit deterministic diagnostics because GL_KHR_shader_subgroup has no direct equivalent."
...
.. csv-table:: stages
   ...
   "Geometry stage", "Y", "Y", "U", "?", "U", "U", "U", "U", "P"
   "Tessellation stages", "Y", "Y", "U", "?", "U", "U", "U", "U", "P"
   "Mesh/task/amplification stages", "P", "P", "P", "?", "U", "U", "U", "U", "P"
   "Ray tracing stages", "P", "P", "P", "P", "U", "U", "U", "U", "P"
...
.. csv-table:: Non-supported or unaudited feature rows
   ...
   "CUDA", "stages", "Geometry stage", "unsupported", "CUDA codegen rejects geometry stages explicitly because CUDA has no geometry shader-stage equivalent."
   "HIP", "stages", "Geometry stage", "unsupported", "HIP codegen rejects geometry stages explicitly because HIP has no geometry shader-stage equivalent."
   ...
   "Rust", "stages", "Geometry stage", "unsupported", "Rust codegen rejects geometry stages explicitly; the Rust backend currently exposes vertex, fragment, and compute shader entry attributes only."
   ...
   "CUDA", "stages", "Tessellation stages", "unsupported", "CUDA codegen rejects tessellation control and evaluation stages explicitly because CUDA has no tessellation shader-stage equivalent."
   "HIP", "stages", "Tessellation stages", "unsupported", "HIP codegen rejects tessellation control and evaluation stages explicitly because HIP has no tessellation shader-stage equivalent."
   ...
   "CUDA", "stages", "Mesh/task/amplification stages", "unsupported", "CUDA codegen rejects mesh, task, object, and amplification-style stages explicitly because CUDA has no mesh shader-stage equivalent."
   ...
   "CUDA", "stages", "Ray tracing stages", "unsupported", "CUDA codegen rejects ray tracing stages explicitly; no CUDA ray pipeline ABI is implemented in this repo."
   "HIP", "stages", "Ray tracing stages", "unsupported", "HIP codegen rejects ray tracing stages explicitly; no HIP ray pipeline ABI is implemented in this repo."
   ...
   "Rust", "stages", "Ray tracing stages", "unsupported", "Rust codegen rejects ray tracing stages explicitly; no Rust ray pipeline ABI is implemented in this repo."
