...
.. csv-table:: Backend inventory
   ...
   "DirectX / HLSL", ".hlsl", "crosstl/translator/codegen/directx_codegen.py", "crosstl/backend/DirectX", "tests/test_translator/test_codegen/test_directx_codegen.py, tests/test_backend/test_directx", "506", "277", "Microsoft Learn HLSL reference; HLSL specification project"
   "OpenGL / GLSL", ".glsl", "crosstl/translator/codegen/GLSL_codegen.py", "crosstl/backend/GLSL", "tests/test_translator/test_codegen/test_GLSL_codegen.py, tests/test_backend/test_GLSL", "701", "146", "GLSL 4.60 specification; OpenGL registry"
   "Metal", ".metal", "crosstl/translator/codegen/metal_codegen.py", "crosstl/backend/Metal", "tests/test_translator/test_codegen/test_metal_codegen.py, tests/test_backend/test_metal", "465", "358", "Apple Metal resources; Metal Shading Language specification"
   "Vulkan SPIR-V", ".spirv", "crosstl/translator/codegen/SPIRV_codegen.py", "crosstl/backend/SPIRV", "tests/test_translator/test_codegen/test_SPIRV_codegen.py, tests/test_backend/test_SPIRV", "350", "11", "SPIR-V unified specification; Khronos SPIR-V registry"
   "CUDA", ".cu", "crosstl/translator/codegen/cuda_codegen.py", "crosstl/backend/CUDA", "tests/test_translator/test_codegen/test_CUDA_codegen.py, tests/test_backend/test_CUDA", "245", "28", "CUDA C++ programming guide"
   ...
   "Rust", ".rs", "crosstl/translator/codegen/rust_codegen.py", "crosstl/backend/Rust", "tests/test_translator/test_codegen/test_rust_codegen.py, tests/test_backend/test_rust", "465", "35", "Rust reference"
   "Slang", ".slang", "crosstl/translator/codegen/slang_codegen.py", "crosstl/backend/slang", "tests/test_translator/test_codegen/test_slang_codegen.py, tests/test_backend/test_slang", "283", "45", "Slang user guide"
...
.. csv-table:: DirectX/OpenGL/Metal backlog
   ...
   "Metal", "stages", "Mesh/task/amplification stages", "partial", "Entry points lower to valid Metal object/mesh function attributes with deterministic names, max_total_threads_per_threadgroup from local-size layouts or explicit attributes, generated or explicit mesh output signatures/topology, SetMeshOutputCounts primitive counts, whole vertex/index/primitive output writes, and single-member output member writes. Multi-member partial output member writes emit compile-safe diagnostics because Metal mesh outputs require whole element setters. Full mesh payload validation and richer partial-write accumulation remain incomplete."
...
.. csv-table:: Non-supported or unaudited feature rows
   ...
   "Slang", "source", "Native preprocessor handling", "partial", "Ray entry points lower to Slang shader stage attributes with deterministic stage names, ray built-ins lower to Slang intrinsics, and payload, hit attribute, and callable data stage interfaces lower to Slang parameter directions. Full ray pipeline object/resource binding and slangc-backed coverage remain incomplete."
   ...
   "DirectX / HLSL", "resources", "GLSL buffer block lowering", "partial", "Covers std140/std430 fixed-only blocks and mixed metadata plus final runtime-array blocks via ByteAddressBuffer, including bool/int/uint/float scalars, vectors, matrices, nested struct leaf fields, struct arrays, layout-distinct aggregate helpers, readonly aggregate helpers, nested aggregate leaf compound stores, aggregate struct load/store with fixed array fields, fixed arrays, int/uint scalar and runtime-array atomics, global-constant fixed sizes, readonly SRV lowering, block arrays, and deterministic diagnostics for unsupported layouts/types."
   "Metal", "resources", "GLSL buffer block lowering", "partial", "Covers std140/std430 fixed-only blocks and mixed metadata plus final runtime-array blocks via explicit pointer/offset lowering, including bool/int/uint/float scalars, vectors, matrices, nested struct leaf fields, struct arrays, layout-distinct aggregate helpers, readonly aggregate helpers, nested aggregate leaf compound stores, aggregate struct load/store with fixed array fields, fixed arrays, int/uint scalar and runtime-array atomics, global-constant fixed sizes, readonly const-device lowering, block arrays, and deterministic diagnostics for unsupported layouts/types."
   "Vulkan SPIR-V", "resources", "GLSL buffer block lowering", "partial", "GLSL-style layout(...) buffer blocks, explicit @glsl_buffer_block declarations, and buffer-qualified runtime-array declarations lower to SPIR-V BufferBlock Uniform descriptors with descriptor set/binding decorations, std430-style member offsets, runtime-array strides, direct block member access, inlined helper parameters, buffer_load/buffer_store helper lowering, and spirv-as/spirv-val coverage. Full std140/scalar layout parity, broader block-array coverage, atomics, and complete memory-qualifier decorations remain incomplete."
