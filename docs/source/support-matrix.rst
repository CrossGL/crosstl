...
.. csv-table:: Backend inventory
   ...
   "Metal", ".metal", "crosstl/translator/codegen/metal_codegen.py", "crosstl/backend/Metal", "tests/test_translator/test_codegen/test_metal_codegen.py, tests/test_backend/test_metal", "423", "413", "Apple Metal resources; Metal Shading Language specification"
...
.. csv-table:: DirectX/OpenGL/Metal backlog
   ...
   "Metal", "stages", "Mesh/task/amplification stages", "partial", "Entry points lower to Metal object/mesh functions, but full mesh payload, topology, and threadgroup layout semantics are not complete."
