...
.. csv-table:: Backend inventory
   ...
   "WebGL / GLSL ES", "webgl2, essl, glsl-es", "", ".webgl.glsl", "crosstl/translator/codegen/webgl_codegen.py", "target-only", "", "tests/test_translator/test_codegen/test_webgl_codegen.py", "62", "58", "WebGL 2.0 specification; OpenGL ES Shading Language 3.00 specification"
