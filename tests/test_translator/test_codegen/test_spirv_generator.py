...
class TestVulkanSPIRVCodeGen:
    ...
    def test_emit(self):
        ...
        assert gen.code_lines == ["OpCapability Shader", "OpMemoryModel Logical GLSL450"]
    ...
    def test_simple_shader_generation(self):
        ...
        struct_members = [
            VariableNode("float", "x"),
            VariableNode("vec2", "uv")
        ]
    ...
    def test_register_input(self):
        gen = VulkanSPIRVCodeGen()
        float_id = gen.register_primitive_type("float")
        float_ptr_id = gen.register_pointer_type(float_id, "Input")
    ...
    def test_register_output(self):
        gen = VulkanSPIRVCodeGen()
        float_id = gen.register_primitive_type("float")
        float_ptr_id = gen.register_pointer_type(float_id, "Output")
